export default function makePostOrganization({ addOrganization, log }) {
   return async function postOrganization(httpRequest) {
      try {
         const organizationInfo = httpRequest.body
         const posted = await addOrganization(organizationInfo)
